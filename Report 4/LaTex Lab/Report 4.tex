...
\section*{Lab 11: Digital Circuits II}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.5\textwidth]{./img/Lab 11/11_5_1.png}  % Replace with the feedback circuit image path
    ...
    \begin{figure}[H]
        ...
        \caption{Oscilloscope Trace Showing Clock Signal and Q Output with Feedback}
        \label{fig:Oscilloscope_Feedback}
    \end{figure}
    ...
    The propagation delay, measured on the oscilloscope, is a critical parameter in sequential circuits. It determines the maximum operating frequency of the flip-flop and is influenced by the feedback connection. This relevance highlights the importance of accounting for propagation delay when designing high-speed digital systems.
