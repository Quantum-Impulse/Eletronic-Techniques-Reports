...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.45\textwidth]{placeholder} % Replace with gain plot
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.45\textwidth]{placeholder} % Replace with phase shift plot
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{placeholder} % Replace with RL circuit and simulation results
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{placeholder} % Replace with circuit diagram
