...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{img/Lab 9/1_1.png} % Replace with the actual circuit diagram
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.45\textwidth]{img/Lab 9/1_2.png} % Replace with gain plot
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.45\textwidth]{img/Lab 9/1_3.png} % Replace with phase shift plot
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{img/Lab 9/1_6.png} % Replace with RL circuit and simulation results
...
This it makes sense that these circuits will behave differently with 
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{img/Lab 9/1_7.png} % Replace with circuit diagram
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.45\textwidth]{img/Lab 9/1_4.png} % Replace with gain plot
    \caption{Gain as a function of frequency}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.45\textwidth]{img/Lab 9/1_5.png} % Replace with gain plot
    \caption{Gain as a function of frequency}
\end{figure}
